...
**Arguments:** The user must provide the full path to the command located (generally) at `/usr/bin/*command`
...
**Output:** The result of the 4 commands, one piped into the next, provided by the user

---
## Usage 
(from main repo README)
